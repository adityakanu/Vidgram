...
const refreshAccessToken = asyncHandler(async (req, res) => {
    ...
    //DOUBT: || req.header("Authorization")?.replace("Bearer ", "")
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    //aggregate pipeline likhne ke baad default mein array return hota hai
    const channel = await User.aggregate([
        ...
        {
            $lookup: {
                from: "subscriptions", // sab kuch lower case or plural mein convert ho jata hai in mongodb
                localField: "_id",
